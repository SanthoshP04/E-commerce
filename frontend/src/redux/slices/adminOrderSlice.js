...
// //update orders delivered status

// export const updateOrderStatus = createAsyncThunk("adminOrders/fetchAllOrders",
//     async ({ id, status }, { rejectWithValue }) => {
//         try {
//             const response = await axios.get(
...
// export const deleteOrder = createAsyncThunk("adminOrders/fetchAllOrders",
//     async (id, { rejectWithValue }) => {
//         try {
//             await axios.delete(
//                 `${import.meta.env.VITE_BACKEND_URL}/api/admin/orders/${id}`,
