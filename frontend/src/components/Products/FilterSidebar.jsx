...
const FilterSidebar = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    brand: [],
    minPrice: 0,
    maxPrice: 10000, // Default max value in rupees
  });

  const [priceRange, setPriceRange] = useState([0, 10000]); // Default range for rupees
  ...
  useEffect(() => {
    ...
    setPriceRange([Number(params.minPrice) || 0, Number(params.maxPrice) || 10000]);
  }, [searchParams]);
    ...
    <div className="p-4">
      ...
      <div className="mb-8">
        ...
        <input
          ...
          name="priceRange"
          min={0}
          max={100000} // Max range in rupees
          step={100} // Increment by 100 rupees
          value={priceRange[1]}
...
//               className={`w-8 h-8 rounded-full border border-gray-400 cursor-pointer transition hover:scale-105 ${
