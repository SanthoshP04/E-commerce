...
router.post("/", async (req, res) => {
    ...
    try {
        ...
        if (cart) {
            ...
            if (productIndex > -1) {
                //if the product already exist,update and the quantity
...
//route PUT /api/cart
//dsec updated product quantity in the cart for the a guest or logged-in user
        ...
        if (guestCart) {
            ...
            if (userCart) {
                ...
                try {
                    ...
                    console.error("Error delecting guest cart:", error);
                }
